...
var secondCmd = &cobra.Command{
	Use:   "2nd",
	Short: "Day 2 of Advent of Code 2023",
	Long: `Day 2 of Advent of Code 2023
Here the problem statement: https://adventofcode.com/2023/day/2`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Printf("Executing %s\n\n", cmd.Short)

		inputPath := "twentythree/inputs/two.input"
...
func init() {
	TwentythreeCmd.AddCommand(secondCmd)
}
...
func dayTwoFirstIsPlayble(game string) bool {
...
func dayTwoSecondPart(scanner *bufio.Scanner) (result int) {
	...
	for scanner.Scan() {
		mat := strings.Split(scanner.Text(), ":")
		result += dayTwoSecondIsPlayble(mat[1])
	}

	return
}

func dayTwoSecondIsPlayble(game string) int {
	noSemicolon := strings.Replace(game, ";", " ", -1)
	noComma := strings.Replace(noSemicolon, ",", " ", -1)
	grab := strings.Fields(noComma)
